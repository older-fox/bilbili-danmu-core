    ...
    live.on('msg', (msg) => {
		...
		switch(msg.cmd){
			...
			//续费舰长消息
				...
				switch (msg.data.guard_level){
					case 1:
					    console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了总督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了总督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了总督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了总督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了总督');
					...
					case 2:
					    console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了提督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了提督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了提督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了提督');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了提督');
					...
					case 3:
					    console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了舰长');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了舰长');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了舰长');
						console.log('['+colors.red(TimeString)+']'+'用户'+colors.brightGreen(msg.data.username)+'续费了舰长');
				}
