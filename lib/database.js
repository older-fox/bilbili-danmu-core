...
async function updateGiftinfo(uid,username,gift_num,coin_type,coin_count,gift_name){
	...
	connection.query(sql,function(err,result){
		if(err){
			...
			if (coin_type == "silver"){
				var sql = "INSERT INTO `gift_info` (`uid`, `username`, `gift_count`, `silver_count`, `gold_count`, `biggest_gift`, `biggest_gift_name`, `biggest_gift_count`, `update_time`) VALUES ('"+uid+"', '"+username+"', '"+gift_num+"', '"+coin_count+"', '0', '0', '0', '0', '"+timestring+"') ON DUPLICATE KEY UPDATE `username` = '"+username+"', `silver_count` = silver_count + "+coin_count+", `update_time` = "+timestring+";"
			}
			if (coin_type == "gold" && coin_count <= current){
				var sql = "INSERT INTO `gift_info` (`uid`, `username`, `gift_count`, `silver_count`, `gold_count`, `biggest_gift`, `biggest_gift_name`, `biggest_gift_count`, `update_time`) VALUES ('"+uid+"', '"+username+"', '"+gift_num+"', '0', '"+coin_count+"', '0', '0', '0', '"+timestring+"') ON DUPLICATE KEY UPDATE `username` = '"+username+"', `gold_count` = gold_count + "+coin_count+", `update_time` = "+timestring+";"
			}
...
async function insertMedal(uid,username,title_name,title_level,title_owner_room,title_owner_uid){
	...
	var sql = "INSERT INTO `title_info` (`uid`, `username`, `title_name`, `title_level`, `title_owner_room`, `update_time`, `title_owner_uid`) VALUES ('"+uid+"', '"+username+"', '"+title_name+"', '"+title_level+"', '"+title_owner_room+"', "+timestring+", "+title_owner_uid+") ON DUPLICATE KEY UPDATE `title_owner_uid` = "+title_owner_uid+", `title_name` = '"+title_name+"', `title_level` = "+title_level+", `update_time` = "+timestring+";";
	}else {
	var sql = "INSERT INTO `title_info` (`uid`, `username`, `title_name`, `title_level`, `title_owner_room`, `update_time`, `title_owner_uid`) VALUES ('"+uid+"', '"+username+"', '"+title_name+"', '"+title_level+"', '"+title_owner_room+"', "+timestring+", "+title_owner_uid+") ON DUPLICATE KEY UPDATE `title_owner_uid` = "+title_owner_uid+", `title_name` = '"+title_name+"', `title_level` = "+title_level+", `title_owner_room` = "+title_owner_room +", `update_time` = "+timestring+";";
	}
